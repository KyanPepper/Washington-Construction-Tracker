...
def scrapeWsMajor():
    ...
    if view_content_div:
        ...
        for link in links:
            ...
            # grab timeline etc..
            timeline = subcontentdiv.find(
                "div",
                class_="field field--name-field-timeline-overview-project field--type-string field--label-hidden field--item",
            ).get_text(strip=True)
            price = subcontentdiv.find(
                "div",
                class_="field field--name-field-funding field--type-string field--label-hidden field--item",
            ).getText(strip=True)
